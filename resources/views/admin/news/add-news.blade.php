...
@section('content')
    ...
    <div class="card mb-4">
        <div class="card-body" style="margin: 20px">
            <form action="{{ route('post-add-new') }}" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
                ...
                <div class="form-group">
                    ...
                    <textarea style="resize: none" name="summary" class="form-control" id="ckeditor1" rows="8"></textarea>
                </div>
                <div class="form-group">
                    <label for="ckeditor" class="control-label">Nội dung</label>
                    <textarea style="resize: none" name="content_news" class="form-control" id="ckeditor" rows="8"></textarea>
                </div>
                <div class="form-group">
